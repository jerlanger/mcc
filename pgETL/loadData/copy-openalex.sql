...
\copy openalex.institutions (id, ror, display_name, type, country_code, homepage_url, image_url, image_thumbnail_url, display_name_acroynyms, display_name_alternatives, works_count, cited_by_count, updated_date) from program 'gunzip -c csv-files/institutions.csv.gz' csv header
...
\copy openalex.authors (id, orcid, display_name, display_name_alternatives, works_count, cited_by_count, last_known_institution, updated_date) from program 'gunzip -c csv-files/authors.csv.gz' csv header
...
\copy openalex.concepts (id, wikidata, display_name, level, description, works_count, cited_by_count, updated_date) from program 'gunzip -c csv-files/concepts.csv.gz' csv header
...
\copy openalex.venues (id, issn_l, issn, display_name, publisher, works_count, cited_by_count, is_oa, is_in_doaj, homepage_url, updated_date) from program 'gunzip -c csv-files/venues.csv.gz' csv header
...
--works
\copy openalex.works (id, doi, mag, pmid, pmcid, title, publication_year, publication_date, type, cited_by_count, is_retracted, is_paratext, is_open_access, abstract) from program 'gunzip -c csv-files/works.csv.gz' csv header escape '\'
...
\copy openalex.works_open_access (work_id, oa_status, oa_url) from program 'gunzip -c csv-files/works_open_access.csv.gz' csv header
